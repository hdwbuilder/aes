...
HD_PWD='C:/Users/shrey/Desktop/AES_SV/AES_SV.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log aes_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aes_main.tcl
